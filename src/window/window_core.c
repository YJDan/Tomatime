...
#define WINDOW_CLASS_NAME L"TomatimeWindowClass"
#define WINDOW_TITLE L"Tomatime"
...
HWND CreateMainWindow(HINSTANCE hInstance, int nCmdShow) {
    ...
    InitFireworks(&g_fireworks, initialWidth, initialHeight);
