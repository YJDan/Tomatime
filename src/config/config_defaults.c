...
static const ConfigItemMeta CONFIG_METADATA[] = {
    ...
    {INI_SECTION_NOTIFICATION, "NOTIFICATION_FIREWORKS_ENABLED", "TRUE", CONFIG_TYPE_BOOL, CFG_OFFSET(notificationFireworksEnabled), CFG_NO_SIZE, "Enable fireworks effect on timer completion"},
