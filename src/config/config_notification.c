...
void WriteConfigNotificationFireworksEnabled(BOOL enabled) {
    g_AppConfig.notification.display.fireworks_enabled = enabled;
    UpdateConfigBoolAtomic(INI_SECTION_NOTIFICATION, "NOTIFICATION_FIREWORKS_ENABLED", enabled);
}
