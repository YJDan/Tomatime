...
#define LOCALAPPDATA_PREFIX            "%LOCALAPPDATA%\\Tomatime"
#define FONTS_PATH_PREFIX              "%LOCALAPPDATA%\\Tomatime\\resources\\fonts\\"
#define AUDIO_PATH_PREFIX              "%LOCALAPPDATA%\\Tomatime\\resources\\audio\\"
#define ANIMATIONS_PATH_PREFIX         "%LOCALAPPDATA%\\Tomatime\\resources\\animations\\"
 ...
 * 
 * @details Returns %APPDATA%\Tomatime\config.ini
 */
 ...
 * 
 * @details Creates %APPDATA%\Tomatime\resources\{audio,fonts,animations}
 */
